...
if [ "$ELIGIBLE" = true ]; then
    echo "   ✅ Header HSTS complet et correct"
    echo ""
    echo "================================================"
    echo "⚠️  LIMITATION - SOUS-DOMAINE :"
    echo "================================================"
    echo ""
    echo "$DOMAIN est un SOUS-DOMAINE."
    echo "hstspreload.org n'accepte QUE les domaines racine."
    echo ""
    echo "Options disponibles :"
    echo ""
    echo "1. ✅ RECOMMANDÉ : Garder le header actuel"
    echo "   - HSTS fonctionne après la première visite"
    echo "   - SecurityHeaders.com : A+"
    echo "   - OWASP Top 10 : 100/100"
    echo "   - Aucun inconvénient"
    echo ""
    echo "2. ⚠️  AVANCÉ : Précharger intelia.com entier"
    echo "   - Nécessite modifier HSTS sur intelia.com"
    echo "   - TOUS les sous-domaines doivent être HTTPS"
    echo "   - Voir HSTS_PRELOAD_GUIDE.md section 'Comment Précharger intelia.com'"
    echo ""
    echo "📖 Documentation complète : HSTS_PRELOAD_GUIDE.md"
    echo ""
else
