...
class ComplianceWrapper:
    ...
    def __init__(self) -> None:
        ...
        self.biosecurity_keywords = {
            "en": ["quarantine", "outbreak", "contamination", "disinfection", "biosecurity",
                   "epidemic", "pandemic", "infection control", "isolation", "decontamination"],
            "fr": ["quarantaine", "épidémie", "contamination", "désinfection", "biosécurité",
                   "pandémie", "contrôle infection", "isolement", "décontamination"],
            "es": ["cuarentena", "brote", "contaminación", "desinfección", "bioseguridad",
                   "epidemia", "pandemia", "control de infección", "aislamiento"]
        }

        # Regulatory keywords
        self.regulatory_keywords = {
            "en": ["regulation", "compliance", "legal", "law", "authorized", "approved",
                   "certification", "standard", "requirement", "mandate"],
            "fr": ["réglementation", "conformité", "légal", "loi", "autorisé", "approuvé",
                   "certification", "norme", "exigence", "mandat"],
            "es": ["regulación", "cumplimiento", "legal", "ley", "autorizado", "aprobado",
                   "certificación", "estándar", "requisito", "mandato"]
        }
    ...
    def get_compliance_level(
        ...
        biosec_kw = self.biosecurity_keywords.get(language, self.biosecurity_keywords["en"])
    ...
    def wrap_response(
        ...
        compliance_level = self.get_compliance_level(query, is_veterinary_query, language)

        # Get role-based disclaimer
        disclaimer = self.get_role_based_disclaimer(user_category, compliance_level, language)
