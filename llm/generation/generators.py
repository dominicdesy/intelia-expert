...
"""
    ...
    def _add_cot_instruction(self, prompt: str, structured: bool = True, language: str = "en") -> str:
        ...
        This method now returns the prompt unchanged for backward compatibility.

        Args:
            prompt: Prompt de base
            structured: Unused (kept for compatibility)
            language: Unused (kept for compatibility)

        Returns:
            Prompt unchanged
        """
        # CoT system has been completely removed - return prompt as-is
        return prompt
