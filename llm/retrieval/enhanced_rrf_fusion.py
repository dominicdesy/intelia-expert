...
class IntelligentRRFFusion:
    ...
    def _detect_genetic_line(self, query_lower: str) -> str:
        ...
        genetic_patterns = {
            ...
            "cobb_500": ["cobb 500", "cobb500", "c500", "c-500", "cobb"],
            "hubbard": ["hubbard", "hub", "hubbard flex", "hubbard classic"],
            "isa_brown": ["isa brown", "isa-brown", "isabrown"],
            "lohmann_brown": ["lohmann brown", "lohmann", "lohmann-brown"],
            "hy_line_brown": ["hy-line brown", "hyline brown", "hy line brown"],
            "hy_line_w36": ["hy-line w-36", "hyline w36", "w-36", "w36"],
        }
