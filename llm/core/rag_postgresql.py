...
Version modulaire utilisant PostgreSQLQueryBuilder et ComparisonHandler
"""
...
class PostgreSQLRetriever:
    ...
    async def search_metrics(
        ...
        top_k: int = 10,
        strict_sex_match: bool = False,  # NOUVEAU paramètre
    ) -> List[MetricResult]:
        """
        ...
        try:
            ...
            # Utilisation du QueryBuilder avec strict_sex_match
...
class PostgreSQLSystem:
    """Main PostgreSQL system - Interface simplifiée"""
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.is_initialized = True
            logger.info("PostgreSQL System initialized")
    ...
    async def search_metrics(
        ...
        top_k: int = 10,
        entities: Dict[str, Any] = None,
        strict_sex_match: bool = False,  # NOUVEAU
    ) -> RAGResult:
        """
        Main search method
        ...
        try:
            metric_results = await self.postgres_retriever.search_metrics(
                ...
                entities=entities,
                top_k=top_k,
                strict_sex_match=strict_sex_match,  # Propagation du paramètre
            )
    ...
    def get_normalization_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "strict_sex_match_supported": True,  # NOUVEAU
        }
