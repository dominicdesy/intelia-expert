...
class InteliaRAGEngine:
        ...
        try:
            ...
            if self.ood_detector:
                try:
                    ...
                    if score_details.get("genetic_metric_present") or score_details.get(
                        "generic_vocab_only"
                    ):
                        self.optimization_stats[
                            "dynamic_ood_threshold_adjustments"
                        ] += 1
    ...
    async def _enhanced_hybrid_search_with_rrf(
        ...
        try:
            ...
            query_context = {"query": original_query, "alpha": alpha, "top_k": top_k}
