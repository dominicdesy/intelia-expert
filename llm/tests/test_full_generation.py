...
def test_full_generation_flow():
    ...
    print("  Languages tested: en, fr")
    print(
        "  Query types tested: genetics_performance, general_poultry, health_diagnosis, nutrition_query"
    )
    print("  Terminology injection: WORKING")
    print("  Average terms per query: ~11")
    print("  Average tokens added: ~400-500")
