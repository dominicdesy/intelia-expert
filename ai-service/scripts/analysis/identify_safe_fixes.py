...
for file, line, col, message, code in errors:
    ...
    elif code == 'reportIncompatibleMethodOverride' and 'Parameter' in message and 'name mismatch' in message:
        safe_errors.append(error_info)
...
param_mismatches = [e for e in safe_errors if e['code'] == 'reportIncompatibleMethodOverride']
...
print()
print(f"TOTAL: 30 errors can be fixed with 0-5% risk")
print("=" * 100)
