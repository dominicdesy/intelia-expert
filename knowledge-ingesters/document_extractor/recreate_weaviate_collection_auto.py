# -*- coding: utf-8 -*-
"""
Script to AUTOMATICALLY recreate Weaviate collection with new schema v2

This script will:
1. Connect to Weaviate
2. List all existing collections
3. DELETE old collection(s) AUTOMATICALLY (no confirmation)
4. Create new InteliaKnowledge collection with schema v2
...
def create_knowledge_chunks_schema(client):
    """
    Create InteliaKnowledge collection with schema v2
    Includes: 60+ fields with quality scores and entity extraction
    """
    print("\n" + "="*80)
    print("CREATING NEW COLLECTION: InteliaKnowledge")
    print("="*80)
...
def main():
    """Main execution"""
    print("="*80)
    print("WEAVIATE COLLECTION RECREATION SCRIPT (AUTOMATIC)")
    print("v2.0.0 - Quality Scoring + Entity Extraction")
    print("="*80)
    print(f"Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("\nWARNING: This will DELETE existing knowledge collections!")
    print()
    ...
    # Step 3: Delete old collection(s) AUTOMATICALLY
    if existing_collections:
        print("\n" + "="*80)
        print("DELETING OLD COLLECTIONS (AUTOMATIC)")
        print("="*80)
        ...
        if collections_to_delete:
            print(f"\nDeleting {len(collections_to_delete)} collection(s):")
