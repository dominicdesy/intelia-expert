...
print("[PATCH] Patching retriever_core.py to use WEAVIATE_VECTOR_DIMENSIONS...")
...
if "import os" not in content:
    ...
    print("[OK] 'import os' already present")
...
if re.search(pattern1, content, re.DOTALL):
    ...
    print("[OK] Replaced hardcoded dimension in __init__")
else:
    print("[WARN] Pattern 1 not found (might be already patched)")

# 3. Replace hardcoded 3072 in fallback
...
if re.search(pattern2, content):
    ...
    print("[OK] Replaced hardcoded dimension in fallback")
else:
    print("[WARN] Pattern 2 not found (might be already patched)")
...
if content != original_content:
    ...
    print("[INFO] Modified: " + file_path)
else:
    print("\n[INFO] No changes needed - file already patched or patterns not found")

print("\n[NEXT] Set WEAVIATE_VECTOR_DIMENSIONS=3072 in Digital Ocean env vars")
