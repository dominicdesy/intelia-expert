...
// ✅ CHANGEMENT 1: Utiliser useAuthStore comme dans UserMenuButton
import { useAuthStore } from '@/lib/stores/auth' 
// ✅ CHANGEMENT 2: Utiliser le singleton au lieu de createClientComponentClient
...
export const InviteFriendModal: React.FC<InviteFriendModalProps> = ({ onClose }) => {
  ...
  useEffect(() => {
    if (!currentUser?.email) {
      ...
      setErrors([]) // Clear errors si utilisateur trouvé
    }
  }, [currentUser])
  ...
  const handleSendInvitations = async () => {
    ...
    try {
      ...
      // Messages d'erreur spécifiques pour debug
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Invitations envoyées par <strong>{currentUser.name || currentUser.email?.split('@')[0] || 'Utilisateur'}</strong>
                </p>
              </div>
