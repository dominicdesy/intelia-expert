...
export const InviteFriendModal: React.FC<InviteFriendModalProps> = ({ onClose }) => {
  ...
  // Forcer les styles au montage - COPIE EXACTE DU BACKUP
  useEffect(() => {
  ...
  // Calcul de currentUser - COPIE EXACTE DU BACKUP
  ...
  const handleSendInvitations = async () => {
    console.log('🖱️ [InviteFriendModal] Bouton "Envoyer" cliqué (version corrigée avec API)')
    ...
    try {
      ...
      console.log('🚀 [InviteFriendModal] Appel API avec payload:', payload)
      ...
      console.log('✅ [InviteFriendModal] Résultat reçu:', response.data)
  ...
  // Affichage si pas d'utilisateur - COPIE EXACTE DU BACKUP
  if (!currentUser?.email) {
    return (
      <>
        <style jsx>{`
