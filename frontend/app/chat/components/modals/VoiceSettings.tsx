    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="relative text-xs text-gray-500 mt-1 h-4">
          ...
          <span className="absolute left-[57.1%] -translate-x-1/2">1.2x {t('voiceSettings.fast') || 'Fast'}</span>
          <span className="absolute right-0">1.5x {t('voiceSettings.veryFast') || 'Very fast'}</span>
        </div>
      </div>
