        ...
        <div ref={overlayRef} className="fixed inset-0 z-50" onClick={onClose}>
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button onClick={onClose} className="text-gray-400 hover:text-gray-600 text-2xl transition-colors hover:bg-gray-100 rounded-full w-8 h-8 flex items-center justify-center">×</button>
            </div>
            <div className="p-6">
              <div className="text-center">
                ...
                <button onClick={onClose} className="px-6 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                  Fermer
                </button>
              </div>
            </div>
