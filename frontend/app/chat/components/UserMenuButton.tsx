...
export const UserMenuButton = () => {
  ...
  // ✅ RESTAURÉ: Logique des initiales de la version .bak
  ...
  // ✅ RESTAURÉ: Vérifier si l'utilisateur est super_admin
  ...
  // ✅ RESTAURÉ: Fonction pour les statistiques (super_admin uniquement)
          ...
          <>
            ...
            <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
              ...
              <div className="border-t border-gray-100 pt-1">
                {/* ✅ RESTAURÉ: Gestion de déconnexion simplifiée */}
                <button
                  onClick={() => {
                    logout()
                    setIsOpen(false)
