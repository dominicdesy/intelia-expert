...
export const UserMenuButton = () => {
  ...
  // 🎯 NOUVEAU: Fonction pour les statistiques (super_admin uniquement)
  ...
  return (
    <>
        ...
        {isOpen && (
          <>
            ...
            <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
              ...
              {/* 🎯 MENU STATISTIQUES - SUPER_ADMIN UNIQUEMENT */}
              {isSuperAdmin && (
                <button
              ...
              {/* 🎯 MENU ABONNEMENT - MASQUÉ POUR SUPER_ADMIN */}
              {!isSuperAdmin && (
                <button
      ...
      {/* 🎯 MODAL ABONNEMENT - SEULEMENT SI PAS SUPER_ADMIN */}
      {!isSuperAdmin && (
        <Modal
