...
// 🚀 STYLE EXACT COMPASS - Analyse détaillée des images
...
export const QuestionsTab: React.FC<QuestionsTabProps> = ({
  ...
  // 🎨 Fonctions utilitaires pour le styling - EXACT Compass
  ...
  // 🚀 FONCTION CSV AVANCÉE - CONVERSATIONS EN LIGNES (inchangée)
  ...
  // 🚀 EXPORT CSV CONVERSATIONS avec choix de scope (inchangé)
...
💡 Ouvrir avec Excel pour format tabulaire !`
  ...
  return (
    <div className="space-y-4">
      {/* 📊 Header avec Tabs - EXACT style Compass */}
      <div className="bg-white border-b border-gray-200">
        <div className="flex items-center space-x-8 px-4 py-3">
          ...
          <div className="flex items-center space-x-3 text-sm">
            <span className="text-gray-500">Total: {totalQuestions}</span>
            <span className="text-gray-500">Utilisateurs: {uniqueUsers.length}</span>
            <span className="text-gray-500">Satisfaction: {feedbackStats.satisfactionRate.toFixed(1)}%</span>
            <span className="text-gray-500">Affichées: {questionLogs.length}</span>
          </div>
          {isLoading && (
      ...
      {/* 🔧 Filtres - Style Compass condensé */}
      <div className="bg-white border border-gray-200">
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Confiance</label>
              <select
      ...
      {/* 📈 Analyse côte à côte - Style Compass exact */}
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="text-center p-3 bg-green-50 border border-green-200">
                <div className="text-xl font-semibold text-green-600">{feedbackStats.positive}</div>
                <div className="text-xs text-green-700">Feedback Positifs</div>
              </div>
              <div className="text-center p-3 bg-red-50 border border-red-200">
                <div className="text-xl font-semibold text-red-600">{feedbackStats.negative}</div>
            ...
            <div className="border-t border-gray-200 pt-3">
              ...
              <div className="space-y-2 max-h-32 overflow-y-auto">
                {questionLogs
                  ...
                  .slice(0, 3)
                  .map((question) => (
                    <div key={question.id} className="border border-gray-200 p-2 hover:bg-gray-50">
                ...
                .map(([source, count]) => {
                  ...
                  return (
                    <div key={source} className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <span className={`inline-flex items-center px-2 py-1 text-xs font-medium ${getSourceColor(source)}`}>
      ...
      {/* 📋 Table des Questions - Style EXACT Compass */}
      <div className="bg-white border border-gray-200">
              ...
              <div key={question.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    {/* En-tête condensé - Style Compass */}
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className={`inline-flex items-center px-2 py-1 text-xs font-medium ${getSourceColor(question.response_source)}`}>
                          {getSourceLabel(question.response_source)}
                        </span>
                        <span className={`inline-flex items-center px-2 py-1 text-xs font-medium ${getConfidenceColor(question.confidence_score)}`}>
                    ...
                    {/* Commentaire de feedback - Compact */}
                    {question.feedback_comment && (
