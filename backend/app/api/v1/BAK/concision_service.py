...
# ✅ CORRECTION: Import OpenAI moderne
from openai import AsyncOpenAI

logger = logging.getLogger(__name__)

# ✅ CORRECTION: Définition des modèles manquants
...
class ConcisionService:
    ...
    def __init__(self, openai_api_key: Optional[str] = None):
        ...
        # ✅ CORRECTION: Initialisation client OpenAI
        ...
        self.concision_prompts = {
            ConcisionLevel.ULTRA_CONCISE: {
                ...
                """,
                "max_tokens": 150,    # ✅ Augmenté de 25 à 150
                "temperature": 0.2    # ✅ Augmenté de 0.1 à 0.2
            },
            ...
            ConcisionLevel.CONCISE: {
                ...
                """,
                "max_tokens": 300,    # ✅ Augmenté de 80 à 300
                "temperature": 0.2
            },
            ...
            ConcisionLevel.STANDARD: {
                ...
                """,
                "max_tokens": 600,    # ✅ Augmenté de 200 à 600
                "temperature": 0.3
            },
            ...
            ConcisionLevel.DETAILED: {
                ...
                """,
                "max_tokens": 1200,   # ✅ Augmenté de 500 à 1200
                "temperature": 0.3
            }
        }
...
Réécris la réponse selon le niveau {level.value}:"""
        ...
        try:
            # ✅ CORRECTION: Appel OpenAI moderne
...
# ✅ CORRECTION: Initialisation avec gestion d'erreurs
try:
    ...
    logger.info("📏 [ConcisionService] Limites de tokens augmentées:")
    logger.info("   - ULTRA_CONCISE: 25 → 150 tokens")
    logger.info("   - CONCISE: 80 → 300 tokens")
    logger.info("   - STANDARD: 200 → 600 tokens")
    logger.info("   - DETAILED: 500 → 1200 tokens")
except Exception as e:
    logger.error(f"❌ [ConcisionService] Erreur initialisation: {e}")
    concision_service = None