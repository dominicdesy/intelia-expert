...
class PostgresMemory:
            ...
            with psycopg2.connect(self.dsn) as conn:
                with conn.cursor() as cur:
                    ...
                    if not table_exists:
                        ...
                        # Créer un index sur updated_at pour optimiser les requêtes de nettoyage
                        cur.execute("""
    ...
    def update(self, session_id, context: dict):
        ...
        """
        try:
            # Si la DB supporte JSONB natif, utiliser directement le dict
            # Sinon, sérialiser en JSON string
            ctx_value = context  # Pour JSONB natif
            ...
            with psycopg2.connect(self.dsn) as conn:
                with conn.cursor() as cur:
                    ...
                    try:
                        ...
                        """, (session_id, json.dumps(context)))  # Toujours sérialiser pour compatibilité
