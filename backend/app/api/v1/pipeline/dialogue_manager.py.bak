# -*- coding: utf-8 -*-
"""
Dialogue orchestration - VERSION HYBRIDE AVEC MÉMOIRE CONVERSATIONNELLE
...
# ---------------------------------------------------------------------------
# Entrée principale AVEC MÉMOIRE CONVERSATIONNELLE
# ---------------------------------------------------------------------------
...
def handle(
    ...
    """
    Fonction principale de traitement des questions - VERSION HYBRIDE AVEC MÉMOIRE CONVERSATIONNELLE
    """
    try:
