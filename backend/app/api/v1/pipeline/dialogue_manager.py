...
# ---------------------------------------------------------------------------
# FONCTION PRINCIPALE HANDLE - VERSION CORRIGÉE
# ---------------------------------------------------------------------------
...
def handle(
    ...
    """
    Fonction principale de traitement des questions - VERSION REFACTORISÉE CORRIGÉE
...
def get_fallback_status() -> Dict[str, Any]:
    ...
    # Statut unifié
    unified_status = {
        "dialogue_manager_version": "refactored_fixed",
...
def test_enhanced_pipeline() -> Dict[str, Any]:
    ...
    try:
        ...
        results["basic_status"] = {
            "dialogue_manager": "refactored_fixed",
            "auto_extraction_fix": "applied",
        ...
        return {
            ...
            "fix_applied": "auto_extraction_systématique",
