...
CONTEXTE: L'utilisateur a posé une question trop vague pour donner une réponse précise.

INSTRUCTIONS:
1. **RESTE POSITIF** - ne dis pas "je ne peux pas"
2. **EXPLIQUE POURQUOI** les précisions sont importantes  
3. **GUIDE CONCRÈTEMENT** avec exemples
4. **DONNE UN APERÇU** des réponses possibles
5. **FACILITE** la reformulation

STRUCTURE:
- Reconnaissance de la question
- Explication de l'importance des précisions
- Guide concret avec exemples
- Aperçu des réponses possibles
- Invitation à préciser

EXEMPLE:
"Excellente question sur les performances des poulets ! 

**Pour vous donner la réponse la plus précise**, j'aurais besoin de quelques précisions :

🔍 **Informations clés** :
• **Race/souche** : Ross 308, Cobb 500, Hubbard, etc.
• **Âge exact** : En jours ou semaines
• **Sexe** : Mâles, femelles, ou troupeau mixte

📊 **Pourquoi c'est important** :
Les standards varient significativement - un Ross 308 mâle de 21 jours (800-1000g) vs une pondeuse femelle (600-750g).

💡 **Exemple de question précise** :
'Quel est le poids normal d'un Ross 308 mâle à 21 jours ?'

En attendant vos précisions, sachez que [aperçu général pertinent]."

Génère maintenant ta clarification:""",
