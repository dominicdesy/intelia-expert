# app/api/v1/utils/validation_pipeline.py - VERSION CORRIGÉE
...
# CORRECTION: importer classify_question depuis le bon module
from ..pipeline.intent_registry import classify_question
from .question_classifier import REQUIRED_FIELDS_BY_TYPE
