# AMÉLIORATION RECOMMANDÉE pour admin.py
...
async def admin_stats(current_user: dict = Depends(get_current_user)) -> Dict[str, Any]:
    ...
    if not current_user.get("is_admin", False) and current_user.get("user_type") != "super_admin":
            ...
            with conn.cursor(cursor_factory=RealDictCursor) as cur:
                ...
                if total_feedback > 0:
                    satisfaction_rate = round(
                        (feedback_stats.get('positive_feedback', 0) / total_feedback) * 100, 1
                    )
                ...
                return {
                    ...
                    "system_overview": {
                        ...
                        "questions_this_month": system_stats.get('questions_this_month', 0),
                        "avg_response_time_ms": float(system_stats.get('avg_response_time_ms', 0) or 0)
                    },
                    ...
                    "performance": {
                        **performance_stats,
                        ...
                        "health_status": "healthy" if performance_stats.get('error_rate_percent', 0) < 5 else "degraded"
                    },
                    "feedback": {
                        **feedback_stats,
