...
🚀 CRÉATION ET GESTION DES RÉPONSES v4.0.0:
...
from .expert_services_utils import (
    safe_get_missing_entities, safe_set_field_if_exists, 
...
class ExpertResponseCreator:
    """Créateur de réponses pour le système expert avec ALIGNMENT COMPLET v4.0.0"""
    ...
    def create_error_response(self, error_message, question_text, conversation_id, language, start_time):
        ...
        try:
            ...
            if MODELS_AVAILABLE:
                ...
                # Ajout response_versions avec vérification
    ...
    def create_critical_clarification_response(
        ...
        try:
            ...
            if MODELS_AVAILABLE:
                ...
                # Ajout champs avec vérification
                if self.config["field_existence_verification"]:
    ...
    def create_enhanced_response_safe_aligned(
        ...
        try:
            if MODELS_AVAILABLE:
                ...
                # Ajout champs avec vérification existence
                if self.config["field_existence_verification"]:
