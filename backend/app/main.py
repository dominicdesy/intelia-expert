...
try:
    ...
    # from app.api.v1 import voice_realtime  # Voice Realtime WebSocket endpoint - DISABLED

    app.include_router(api_v1_router)
    # app.include_router(voice_realtime.router, prefix="/v1", tags=["voice-realtime"])  # Voice Realtime - DISABLED
    logger.info("Router API v1 charge depuis __init__.py")
    # logger.info("Voice Realtime router charge (WebSocket /v1/ws/voice)")  # DISABLED
except ImportError as e:
