...
CHUNK_TYPE_TABLE = "table"  # ✅ ajouté : type explicite pour les chunks tabulaires
...
class PerformanceTableParser(BaseParser):
                    ...
                    if structured_content:
                        doc = Document(
                            ...
                            metadata=self.create_base_metadata(file_path, {
                                'chunk_type': CHUNK_TYPE_TABLE,  # ✅ ajouté
                                ...
                                'extraction_method': 'performance_table_parser_excel'
                            })
                        )
    ...
    def _create_structured_document(self, table_section: Dict[str, Any], 
        ...
        # ✅ le chunk est explicitement marqué comme table
        return Document(
            page_content='\n'.join(content_parts),
            metadata=self.create_base_metadata(file_path, {
                'chunk_type': CHUNK_TYPE_TABLE,  # ✅ ajouté
                ...
                'extraction_method': 'performance_table_parser_pdf'
            })
        )
